...
import { closeFeedbackHistory, deleteFeedbackHistory, migrateCoffeesInitialValues } from './feedback.js';
...
function initEventListeners() {
    ...
    const closeFeedbackHistoryBtn = document.getElementById('closeFeedbackHistoryBtn');
    if (closeFeedbackHistoryBtn) {
        closeFeedbackHistoryBtn.addEventListener('click', (e) => { e.preventDefault(); e.stopPropagation(); closeFeedbackHistory(); });
    }

    const deleteFeedbackHistoryBtn = document.getElementById('deleteFeedbackHistoryBtn');
    if (deleteFeedbackHistoryBtn) {
        deleteFeedbackHistoryBtn.addEventListener('click', (e) => { e.preventDefault(); e.stopPropagation(); deleteFeedbackHistory(); });
    }

    const feedbackHistoryModal = document.getElementById('feedbackHistoryModal');
    if (feedbackHistoryModal) {
        feedbackHistoryModal.addEventListener('click', (e) => { if (e.target === e.currentTarget) closeFeedbackHistory(); });
    }
